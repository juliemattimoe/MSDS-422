...
# Next, we go into Random Forest Regression
from sklearn.ensemble import RandomForestRegressor
#You can use other hyperparameters as well to get better accuracy
model = RandomForestRegressor(bootstrap = True, n_estimators= 100, max_features = 'log2')
